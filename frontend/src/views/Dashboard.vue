<template>
  <div class="page pb-32 md:pb-24">
    ...
    <div v-if="confirmDelete" class="fixed inset-0 z-[65] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm" @click.self="confirmDelete = null" role="dialog" aria-modal="true" aria-label="Delete task">
